...
// Task 311: карточка сотрудника зачищена (Шаблон ротации/Сотрудник/Итого в году убраны),
// пояснительные hover-окна и title-тултипы ячеек убраны, кнопка «+ Сотрудник»
// заменена заголовком «Сотрудник» в шапке сетки.
// Task 312: «+ Отпуск» из тулбара — строкой в блок отпусков карточки сотрудника;
// в попапе ячейки убраны «— выходной —» и коды мероприятий из списка основных.
// Task 313: подсветка сегодняшней даты в шахматке (шапка+ячейки); окно
// «Мероприятия в этот день» НАД окном кодов при клике по ячейке.
// Task 314: «.» показывается как «·» на фоне ПУСТОЙ ячейки (код #EEF0F2);
// мероприятия «Инструктажи» — бейджи-«иконки» в ячейках; локальная копия
// графика (мгновенное открытие) + кнопка «Обновить» данных графика.
// Партия 312+313+314 = один инкремент (только фронтенд).
const CACHE_VERSION = 'kipia-v417';
