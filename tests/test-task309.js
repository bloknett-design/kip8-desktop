...
describe('Task 309 — Service Worker', () => {
    ...
    test('SW: версия кэша kipia-v415', () => {
        assertTrue(SW_SRC.indexOf("CACHE_VERSION = 'kipia-v415'") !== -1,
            'CACHE_VERSION в sw.js = kipia-v415');
        assertFalse(SW_SRC.indexOf('kipia-v413') !== -1,
