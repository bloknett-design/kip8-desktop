...
// Task 245 (перенос в kip8): SW-блок версии v399 удалён — версия v400 введена
// в Task 247 (см. describe ниже). Историческая заметка.

// Task 247 (перенос из kip8test@ed7f623): дата «за ДД.ММ.ГГГГ г.» в строке
// «Последние показания» — единый неразрывный блок. При нехватке ширины
// (мобильные экраны) весь текст «за 29.08.2026 г.» переносится на новую
// строку ЦЕЛИКОМ, а не по словам:
...
// Task 247 (перенос в kip8): SW-блок версии v400 удалён — версия v401 введена
// в Task 248 (см. describe ниже). Историческая заметка.

// Task 248 (перенос в kip8): столбец «Комментарий» таблицы «Хронология
// показаний» — текст размещается максимум в 4 строки; если при этой ширине
// столбца весь текст не помещается, ширина столбца подгоняется (не меняя
// 4 строк) так, чтобы помещался ВЕСЬ текст. Причина бага: эвристика Task 221
