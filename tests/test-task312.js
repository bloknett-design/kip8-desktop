...
//   SW: kipia-v417 (в kip8test Task 313 поднимал v551→v552 — окно
//       мероприятий над окном кодов + подсветка сегодняшней даты;
//       в kip8 партия 312+313+314 = один инкремент с v416).
//
