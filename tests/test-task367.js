...
describe('Task 367 — SW кэш', () => {
    ...
    test('SW: CACHE_VERSION = kipia-v457', () => {
    ...
    test('SW: нет v595 (старая) и нет v597 (двойной бамп)', () => {
        assertTrue(SW_SRC.indexOf('kipia-v444') === -1, 'старая версия не осталась');
        assertTrue(SW_SRC.indexOf('kipia-v458') === -1, 'двойного бампа не было');
    });
});
