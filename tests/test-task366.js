...
describe('Task 366 — SW кэш', () => {
    ...
    test('SW: CACHE_VERSION = kipia-v451', () => {
    ...
    test('SW: нет v594 (старая) и нет v596 (двойной бамп)', () => {
        assertTrue(SW_SRC.indexOf('kipia-v442') === -1, 'старая версия не осталась');
        assertTrue(SW_SRC.indexOf('kipia-v452') === -1, 'двойного бампа не было');
    });
});
