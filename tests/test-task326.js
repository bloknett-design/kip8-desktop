...
//   SW: kipia-v457 (v566 не существует).
//
...
describe('Task 326 BUGFIX — структура HTML: закрытие #page-work-schedule', () => {
    ...
    test('SW: актуальная версия kipia-v457 (Task 326)', () => {
        assertTrue(SW_SRC.indexOf("const CACHE_VERSION = 'kipia-v457'") !== -1,
            'CACHE_VERSION = kipia-v457 в sw.js');
