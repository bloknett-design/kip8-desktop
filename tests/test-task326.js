...
//   SW: kipia-v458 (v566 не существует).
//
...
describe('Task 326 BUGFIX — структура HTML: закрытие #page-work-schedule', () => {
    ...
    test('SW: актуальная версия kipia-v458 (Task 326)', () => {
        assertTrue(SW_SRC.indexOf("const CACHE_VERSION = 'kipia-v458'") !== -1,
            'CACHE_VERSION = kipia-v458 в sw.js');
