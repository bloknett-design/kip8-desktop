...
//   SW: kipia-v467 (v566 не существует).
//
...
describe('Task 326 BUGFIX — структура HTML: закрытие #page-work-schedule', () => {
    ...
    test('SW: актуальная версия kipia-v467 (Task 326)', () => {
        assertTrue(SW_SRC.indexOf("const CACHE_VERSION = 'kipia-v467'") !== -1,
            'CACHE_VERSION = kipia-v467 в sw.js');
        assertFalse(SW_SRC.indexOf('kipia-v468') !== -1,
